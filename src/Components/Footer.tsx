const Footer = () => {
  return (
    <section className="py-10 bg-gray-900 sm:pt-16 lg:pt-24">
      <div className="p-12 flex flex-wrap justify-around item-center">
        <img
        ...
        <div>
          <p className="text-white font-rubik text-3xl">
            Let’s Discussed About Your Projects
          </p>
        </div>
        <div>
          <button className="bg-[blue] text-white ps-2 py-2 pe-2 rounded-md">
            GET STARTED
          </button>
        </div>
      </div>
      <div className="px-5 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
          <div>
            ...
            <ul className="flex items-center space-x-3 mt-3 md:order-3">
              <li>
                <a
                  href="#"
                  title=""
          ...
          <div>
            <p className="text-base text-white">Quick Link</p>
          ...
          <div className="flex flex-col gap-2">
            <p className="text-base text-white">Get In Touch</p>
            <div className="flex flex-col gap-3">
              ...
              <div>
                <p className="text-white">+000 (123) 456 88</p>
              </div>
            </div>
          </div>
          <div>
            <p className="text-base text-white">Recent News</p>
        ...
        <div className="flex flex-wrap items-center justify-between">
          <div>
            <ul className="flex text-white justify-center item-center gap-3">
              <li>FAQs</li>
